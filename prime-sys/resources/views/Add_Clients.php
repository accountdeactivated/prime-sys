          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="Add_Clients_Controller/insert">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Car Brand</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Plate #</label>
                          <input type="text" class="form-control" name="platenum" id="platenum">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div align="right">
                      <button type="button" class="btn btn-primary clientD" data-toggle="modal" data-target="#myModalView">Submit
                          <i class="material-icons" >check_box</i></button>
                      <button type="button" class="btn btn-primary clientD" onclick="location.href='<?php echo base_url();?>index.php/Client'" >Back
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div align="left">
                                        ...
                                        <h6>Car Brand:&nbsp;&nbsp; <b id="modal_brand"></b></h6>
                                        <h6>Car Model:&nbsp;&nbsp; <b id="modal_model"></b></h6>
                                        <h6>Plate #:&nbsp;&nbsp; <b id="modal_platenum"></b></h6>
