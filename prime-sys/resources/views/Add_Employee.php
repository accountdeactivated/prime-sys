          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="Add_Employee_Controller/insert">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div align="right">
                      <button type="button" class="btn btn-primary employeeD" data-toggle="modal" data-target="#myModalView">Submit
                          <i class="material-icons" >check_box</i></button>
                      <button type="button" class="btn btn-primary employeeD" onclick="location.href='<?php echo base_url();?>index.php/Employee'" >Back
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div align="left">
                                        ...
                                        <h6>Contact Person:&nbsp;&nbsp; <b id="modal_position"></b></h6>
                                        <h6>Email:&nbsp;&nbsp; <b id="modal_email"></b></h6><b id="modal_email"></b>
...
<script type="text/javascript">
    ...
    window.onload = function() {
        $('.employeeD').click(function() {
            //var idEmployees = $(this).attr('value');
