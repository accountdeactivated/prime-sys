                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table" id="dataTable" width="" height="150">
                                            ...
                                            <tbody>
                                                <form method="POST" action="Supplier_Controller/get_item" name="rowItem">
                                                <?php
                        ...
                        <button type="button" rel="tooltip" title="Back" style="float:right" class="btn btn-primary btn-round" onclick="location.href='<?php echo base_url();?>index.php/SDashboard_Controller'">
