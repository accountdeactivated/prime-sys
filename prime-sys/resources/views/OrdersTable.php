                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">Orders (Does not display orders yet fix db, still displays inventory)
                                    <button type="button" rel="tooltip" title="Add New Supplier" class="btn btn-primary btn-fab btn-fab-mini btn-round" onclick="location.href='<?php echo base_url();?>index.php/Add_Material'">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive tabil">
                                        ...
                                        <h5 class="text-center"> ----------End of Report----------</h1>
                                        </div>
