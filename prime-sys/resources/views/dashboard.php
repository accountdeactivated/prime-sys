    ...
    <div class="main-panel">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink" >
                  <a class="dropdown-item" href="<?php echo base_url();?>index.php/Dashboard_Controller/logout">Logout</a>
                </div>
              </li>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4">
              <button class="btn btn-primary btn-block" onclick="demo.showNotification('top','center')"> </button>
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 href="#" rel="tooltip" title="View Monthly Revenue Report" class="card-title btn btn-primary btn-round btn-warning">Monthly Revenue</h4>
                  <p class="card-category">Last Year's Performance</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 href="#" rel="tooltip" title="View Completed Tasks Report" class="card-title btn btn-primary btn-round btn-danger">Completed Tasks</h4>
                  <p class="card-category">Last Month's Performance</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> report sent 2 days ago
